...
public class InstructorProfileController {
    ...
    @GetMapping("/instructorProfiles")
    private ResponseEntity<List<InstructorProfileDTO>>getAllInstructorProfiles() {
        return new ResponseEntity<>(instructorProfileService.getAllInstructorProfiles(), HttpStatus.OK);
    }
}
